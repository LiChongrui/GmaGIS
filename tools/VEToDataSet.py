...
def Fun(InFile, OutFile, Resolution = 1, Attribute = None, Boundary = None, NoData = None, Format = 'ESRI Shapefile'):
    Layer = io.ReadVector(InFile)
    
    Result = Layer.ToDataSet(Resolution, Attribute, Boundary, NoData)
