...
def Fun(InFile, OutFile, Format = 'GTiff', **kwargs):
    ...
    def CalVe():
        ...
        Result = climet.Diagnosis.Pettitt(Data, Axis = 0)._asdict()
    ...
    def CalRa():
        ...
        Resultp = np.zeros((Rows, Columns), dtype = dt)
        ...
        OutFileSta = BName + '_sta(Max Pettitt U)' + EXT
        OutFilep = BName + '_p' + EXT
