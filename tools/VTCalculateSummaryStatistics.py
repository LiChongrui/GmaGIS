...
def Fun(InFile, OutFile, Statistics, Case, StatisticsTypes = 'mean', Format = 'ESRI Shapefile'):
    Layer = io.ReadVector(InFile)
    
    Result = Layer.CalculateSummaryStatistics(Statistics, Case, StatisticsTypes)
