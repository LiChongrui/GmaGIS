...
from core.iplib import io, np, pd, climet, env
from core.utils import GetIcon

Title = None
Icon = None
  
def Fun(InFilePRE, InFilePET, OutFile, TimeScale = 1, Periodicity = 12, 
        Distribution = 'LogLogistic', FitMethod = 'LMoment', 
        Calibration = None, Format = 'GTiff', **kwargs):
    ...
    def CalVe():
        ...
        Result = climet.Index.SPEI(PRE, PET, 
                                   Axis = 0,
                                   Scale = TimeScale,
    ...
    def CalRa():
        ...
        for i, st in enumerate(Slice):
            ...
            Index = climet.Index.SPEI(PRE, PET, 
                                      Axis = 0,
                                      Scale = TimeScale,
                                      Periodicity = Periodicity,
                                      Distribution = Distribution,
